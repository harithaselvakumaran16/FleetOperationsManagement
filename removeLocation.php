...
<body>
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <a class="navbar-brand" href="#">Remove Location</a>
            ...
            <div class="col-md-6 offset-md-3">
                <form action="adminFunctions.php" method="post">
                    <div class="form-group">
                        <label for="exampleFormControlSelect1">Select Location (Remove the cars and supervisors before delete):</label>
                    ...
                    <button type="submit" name="removeLocation" class="btn btn-primary">Remove Location</button>
                </form>
            </div>
        </div>
    </div>
